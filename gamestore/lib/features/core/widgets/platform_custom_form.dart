  ...
  Widget build(BuildContext context) {
    return FormBuilder(
      child: PlatformWidget(
            ...
            children: [
              for (final field in fields.entries)
                ValueListenableBuilder<bool>(
                  ...
                  builder: (context, isEnabled, _) => TextFormField(
        ...
        cupertino: (context, _) => fields.length == 1
...
class _ListenableCupertinoTextFormField extends StatelessWidget {
  const _ListenableCupertinoTextFormField({
    required this.field,
    required this.isEnabledListenable,
  });
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<bool>(
      valueListenable: field.value.isEnabledListenable,
      builder: (context, isEnabled, _) => CupertinoTextFormFieldRow(
